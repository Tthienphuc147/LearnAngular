  ...
  submit(): Observable<any> {
    const httpOptions = {
      headers: new HttpHeaders({
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..sF72gMTLNeaA3vSXXcjzIAMzW4lRwTi_OIP90R3Nsyg'
      })
    };
    // tslint:disable-next-line:max-line-length
    const body = {
